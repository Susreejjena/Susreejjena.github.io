...
export const socialData = [
  { link: 'https://github.com/Susreejjena/', icon: <Github /> },
  { link: 'https://www.linkedin.com/in/susree-jyotrimayee-jena/', icon: <Linkedin /> },
  { link: 'https://www.instagram.com/susree.jjena/', icon: <Instagram /> }
]
